...
ชุดข้อมูลนี้เกี่ยวกับปัจจัยสุขภาพของผู้ป่วยโรคเบาหวาน ที่จะนำมาใช้ในการประเมินและทำนายผู้ที่มีความเสี่ยงเป็นชุดข้อมูลนี้เกี่ยวกับปัจจัยสุขภาพของผู้ป่วยโรคเบาหวาน ที่จะนำมาใช้ในการประเมินและทำนายผู้ที่มีความเสี่ยงเป็นโรคเบาหวาน

## ตัวแปรในชุดข้อมูล

| Attribute | Description |
|----------|-------------|
| Id | หมายเลขประจำข้อมูลแต่ละแถว |
| Pregnancies | จำนวนครั้งที่ตั้งครรภ์ |
| Glucose | ระดับน้ำตาลในเลือดหลังดื่มน้ำตาล 2 ชั่วโมง (OGTT) หน่วย mg/dL |
| BloodPressure | ความดันโลหิตช่วงคลายตัว (Diastolic) หน่วย mmHg |
| SkinThickness | ความหนาของไขมันใต้ผิวหนัง (Triceps) หน่วย mm |
| Insulin | ระดับอินซูลินหลังดื่มน้ำตาล หน่วย µU/mL |
| BMI | ดัชนีมวลกาย (กก. / ม²) |
| DiabetesPedigreeFunction | คะแนนความเสี่ยงเบาหวานจากพันธุกรรม |
| Age | อายุ (ปี) |
| Outcome | 1 = เป็นเบาหวาน, 0 = ไม่เป็นเบาหวาน |
